...
public class LocalizationConfiguration extends AcceptHeaderLocaleContextResolver implements WebMvcConfigurer {
  ...
  private static final String DEFAULT_LANGUAGE_NAME = "pt_BR";
  private static final List<String> SUPPORTED_LANGUAGE = List.of("pt_BR");
  
  @Bean
  public ResourceBundleMessageSource messageSource() {
    var source = new ResourceBundleMessageSource();
    source.setBasename("i18n/coffee");
