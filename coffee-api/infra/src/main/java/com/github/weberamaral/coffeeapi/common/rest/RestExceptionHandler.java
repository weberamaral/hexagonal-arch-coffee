...
public class RestExceptionHandler extends BaseController {
  ...
  @ExceptionHandler(com.github.weberamaral.coffeeapi.common.exception.CoffeeApiBusinessException.class)
  @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
  public Response<ErrorResponse> handleTicketApiBusinessException(com.github.weberamaral.coffeeapi.common.exception.CoffeeApiBusinessException ex, Locale locale) {
    return createErrorResponseFromMessageSource(ex.getKey(), locale, ex.getArgs());
  }

  @ExceptionHandler(com.github.weberamaral.coffeeapi.common.exception.CoffeeApiDataNotFoundException.class)
  @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
  public Response<ErrorResponse> handleTicketApiDataNotFoundException(com.github.weberamaral.coffeeapi.common.exception.CoffeeApiDataNotFoundException ex, Locale locale) {
    return createErrorResponseFromMessageSource(ex.getKey(), locale, ex.getArgs());
  }
